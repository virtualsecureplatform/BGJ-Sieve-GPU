...
common="SOURCE_COMMIT=${SOURCE_COMMIT},SVP_DIMENSION=143,SVP142_LATTICE_SEED=14,SVP_INSTANCE=svp143-seed14,SVP142_REPRO=${SOURCE}/reproduce/svp143-seed14/reproduce.py,SVP_PREPROCESS_MODE=lll-potlllbkz,SVP_BKZ_BETA=64,SVP_BKZ_LOOPS=8"
...
cd "$SOURCE"
prep="$(sbatch --parsable --job-name=svp143-s14-lpotprep --time=01:15:00 \
    --export="ALL,${common}" prepare_svp142_seed0_a100x4.sbatch | cut -d';' -f1)"
run="$(sbatch --parsable --job-name=svp143-s14-lpot64 \
